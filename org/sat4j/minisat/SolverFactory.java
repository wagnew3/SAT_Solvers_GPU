...
public final class SolverFactory extends ASolverFactory<ISolver> {
    ...
    public static Solver<DataStructureFactory> newMiniLearningHeapRsatExpSimpML(MLSATSAT4J mlSAT, int numberVariables) {
    ...
    public static ICDCL<DataStructureFactory> newGlucose21ML(MLSATSAT4J mlSAT, int numberVariables) {
    ...
    public static MLSolver newDefaultML(MLSATSAT4J mlSAT, int numberVariables) {
